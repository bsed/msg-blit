...
#ifndef KV_STORE_RT_HPP_
#define KV_STORE_RT_HPP_
...
public:
   ...
   // Recieve datastore updates through transactions from other publishers
   void receiveUpdates();

   // Publish pending datastore transactions
   void publishPending();
