...
int main(int argc, char *argv[]) {
   ...
   // Publish pending updates in a database transaction
   database->publishPending();
   ...
   while (true) {
      ...
      // Update database from transactions from other publishers
      database->receiveUpdates();
